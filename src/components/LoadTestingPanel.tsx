...
import { Play, Activity, Clock, Zap, CheckCircle2 } from 'lucide-react';
...
export const LoadTestingPanel: React.FC = () => {
  ...
  const startTest = async () => {
    ...
    try {
      ...
      toast.error('Falha no load test: ' + String(error));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="load-test-config">
        ...
        <div className="config-group">
          ...
          <input
            ...
            onChange={(e) =>
              setConfig({ ...config, requestsPerUser: parseInt(e.target.value) || 1 })
            }
            min="1"
          />
        </div>
          ...
          <div className="stats-summary">
            ...
            <div className="stat-row">
              ...
              <span className="stat-value">
                {report.minTimeMs}ms / {report.maxTimeMs}ms
              </span>
            </div>
          </div>
